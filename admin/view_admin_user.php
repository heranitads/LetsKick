...
<ul class="nav navbar-nav navbar-right">
  ...
  <strong>Success!</strong> Data member berhasil dimasukan !
					...
					<div class="form-group">
						<label for="text">Nama Admin  :   <?php echo $b['nama_admin']; ?>  </label>
							...
							<div class="form-group">
							<label for="text">Alamat  :   <?php echo $b['alamat']; ?>   </label>
							</div>
							
							<div class="form-group">
							<label for="comment">Nomor Telepon :  <?php echo $b['no_telp']; ?> </label>
							</div>
