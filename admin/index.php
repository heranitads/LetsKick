						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-4">
									<div class="metric">
										...
										$a = mysqli_query($conn, "select count(idmember) from member");
										$b = mysqli_fetch_array($a)
										?>
											<span class="number"> <?php echo $b['count(idmember)']; ?></span>
											<span class="title">Jumlah Member Terdaftar </span>
										</p>
									</div>
								</div>
								<div class="col-md-4">
									<div class="metric">
										...
										$b = mysqli_fetch_array($a)
										?>
											<span class="number"> <?php echo $b['count(id_penyedia_futsal)']; ?></span>
											<span class="title">Jumlah Penyedia futsal Terdaftar</span>
										</p>
									</div>
								</div>
								<div class="col-md-4">
									<div class="metric">
										...
										$a = mysqli_query($conn, "select count(id_transaksi) from transaksi");
										$b = mysqli_fetch_array($a)
										?>
											<span class="number"> <?php echo $b['count(id_transaksi)']; ?> </span>
											<span class="title">Jumlah Transaksi yang dilakukan</span>
										</p>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<div class="weekly-summary text-right">
										<span class="number"> </span> <span class="percentage"><i class="fa fa-caret-up text-success"></i> 23%</span>
