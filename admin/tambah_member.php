					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<form method="post" action="tambah_member.php?act=tambah" enctype="multipart/form-data">
...
$path = "images/".$nama_file;
	...
	$gambar="'". $path ."'";
$sql = "INSERT INTO member (Idmember, nama_member, alamat, no_hp, email, username, password, foto)
VALUES ($d, $nama_member, $alamat, $no_hp, $email, $username, $password, $gambar )";

if (mysqli_query($conn, $sql)) {
	echo "<script>window.location='tambah_member.php?act=success_tambah'</script>";
