...
<body>
					...
					<div id="navbar-menu" class="navbar-collapse collapse">
						...
						<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a href="view_admin_user.php"><i class="lnr lnr-user"></i> <span>My Profile</span></a></li>
									<li><a href="edit_admin_user.php"><i class="lnr lnr-cog"></i> <span>Settings</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<?php
											...
											$a = mysqli_query($conn, "select * from admin where id_admin ='".$_SESSION['id_admin']."'");
											$b = mysqli_fetch_array($a);

										?>
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Ubah Profil Admin</h3>
								</div>
								<div class="panel-body">
								<form method="post" action="edit_admin.php?act=ubah" enctype="multipart/form-data">
								
								 <div class="form-group">
    <label for="text">Nama Admin</label>
	  <input type="hidden" class="form-control" name ="id_admin" value = "<?php echo $b['id_admin']; ?> ">
 
    <input type="text" class="form-control" name ="nama_admin" value = "<?php echo $b['nama_admin']; ?> ">
  </div>
   <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name ="no_telp" value = "<?php echo $b['no_telp']; ?> " >
  </div>
  <div class="form-group">
...
$sql = "update admin set  nama_admin =$nama_admin, alamat = $alamat, no_telp = $no_telp, email = $email, username =$username, password = $password, foto = $gambar where id_admin = '$c'";

if (mysqli_query($conn, $sql)) {
	echo "<script>window.location='view_admin.php?act=success_ubah';</script>";
