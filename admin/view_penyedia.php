...
<div class="sidebar">
		...
		<!-- END NAVBAR -->
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Daftar Penyedia Futsal</h3>
					<?php 
					error_reporting(0);
					session_start();
					...
					if($_REQUEST['act'] == "success_update"){
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<button type="button"  class="btn btn-success pull-right" onclick="window.location.href='penyedia.php';" >Tambah</button>
...
$no++;
										...
										<tr>
												...
												<td><?php echo $no; ?></td>
												<td><?php echo $b['id_penyedia_futsal']; ?></td>
												<td><?php echo $b['nama_penyedia']; ?></td>
												<td><?php echo $b['nama_pemilik']; ?></td>
												<td><button type="button" class="btn btn-info" onclick="window.location.href='view_detail_penyedia.php?id=<?php echo $b['id_penyedia_futsal']; ?>'; ">view detail</button><button type="button" class="btn btn-primary" onclick="window.location.href='edit_penyedia.php?id=<?php echo $b['id_penyedia_futsal']; ?>'; ">Edit</button><button type="button" class="btn btn-danger" onclick="window.location.href='hapus_penyedia.php?id=<?php echo $b['id_penyedia_futsal']; ?>'; ">Hapus</button></td>
