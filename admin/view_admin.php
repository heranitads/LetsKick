  ...
  <strong>Success!</strong> Data member berhasil dihapus !
					...
					?>
							<div class="panel">
								...
								<button type="button"  class="btn btn-success pull-right" onclick="window.location.href='tambah_admin.php';" >Tambah</button>
...
$no++;
										...
										<tr>
											<td>
												...
												<td><button type="button" class="btn btn-info" onclick="window.location.href='view_detail_admin.php?id=<?php echo $b['id_admin']; ?>'; ">view detail</button><button type="button" class="btn btn-primary" onclick="window.location.href='edit_admin.php?id=<?php echo $b['id_admin']; ?>'; ">Edit</button><button type="button" onclick="window.location.href='hapus_admin.php?id=<?php echo $b['id_admin']; ?>'; " class="btn btn-danger">Hapus</button></td>
