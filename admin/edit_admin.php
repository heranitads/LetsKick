				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<?php
											...
											$a = mysqli_query($conn, "select * from admin where id_admin ='".$_REQUEST['id']."'");
$b = mysqli_fetch_array($a);

										?>
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">ubah admin</h3>
								</div>
...
$sql = "update admin set  nama_admin =$nama_admin, alamat = $alamat, no_telp = $no_hp, email = $email, username =$username, password = $password, status = $status, foto = $gambar where id_admin = '$c'";
