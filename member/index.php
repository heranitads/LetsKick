...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Let's Kick | Pencarian tempat futsal</title>
  ...
  <body class="fixed-header no-header  ">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-menu">
        ...
        <ul class="menu-items">
          <li class="m-t-30 " class="active open">
      ...
      <div class="page-content-wrapper full-height">
        ...
        <div class="content full-width full-height overlay-footer">
          ...
          <div class="map-container full-width full-height">
            <div id="googleMap" class="full-width full-height"></div>
          </div>
          <!-- END CONTENT INNER -->
        </div>
        <!-- END PAGE CONTENT -->
	...
	<script>
function myMap() {
 //set map di panel googleMap(buka)
  var map = new google.maps.Map(document.getElementById('googleMap'), {
    center: {lat: -34.397, lng: 150.644},
    zoom: 17 //perbesar wilayah
  });
  
   //set map di panel googleMap(tutup)

    //buat tombol zoom in dari id map-zoom-in (buka)
   var  zoomInButton = document.getElementById('map-zoom-in');
   
    google.maps.event.addDomListener(zoomInButton, 'click', function() {
    map.setZoom(map.getZoom() + 1);
  });
   //buat tombol zoom in dari id map-zoom-in (tutup)
   
    //buat tombol zoom out dari id map-zoom-out (buka)
...
//operasi geolocation(buka)
  ...
  //operasi geolocation(tutup)
  
  //set marker dimap(buka)
   setMarkers(map);
    //set marker dimap(tutup)
}
...
function setMarkers(map) {
 ...
 var infowindow = new google.maps.InfoWindow();  //definisi panel buat show rincian tempat
  var marker, i;  //definisi variabel buat marker sama untuk perulangan ambil data (for)
  for (var i = 0; i < locations.length; i++) {
    // ambil semua data wilayah dan buat markernya (buka)
   ...
   ;
    ...
    // click marker dan muncul semua data (buka)
	  ...
	  //click marker dan muncul semua data (tutup)
  }
}
//Operasi buat marker(tutup)
	...
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAmN4anJT1Y0TeEzr0oP7M1KgqFUM6WTEw&callback=myMap"></script>
