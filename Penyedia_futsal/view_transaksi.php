			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="view_penyedia.php" class=""><i class="lnr lnr-code"></i> <span>Lapangan</span></a></li>
						<li><a href="view_member.php" class="active"><i class="fa fa-money"></i> <span>Transaksi</span></a></li>
						</ul>
				</nav>
			</div>
...
$no++; //melakukan penomoran
										...
										<tr>
												...
												<td><?php echo $b['nama_member'];//menampilkan data dari field nama_member ?></td>
												...
												<td><button type="button" class="btn btn-info" onclick="window.location.href='view_detail_transaksi.php?id=<?php echo $b['id_penyedia_futsal']; ?>'; ">view detail</button><button type="button" class="btn btn-primary" onclick="window.location.href='edit_penyedia.php?id=<?php echo $b['id_penyedia_futsal']; ?>'; ">Verifikasi</button></td>
